        ...
        <div className="flex flex-col lg:flex-row items-center">
          ...
          <div className="lg:w-2/3 text-center lg:text-left ml-7">
            ...
            <p className="text-lg  mb-6 font-serif">
              Hi, I’m Ankur Kumar, a motivated and enthusiastic software developer eager to kickstart my career in the tech industry. <strong> I am pursing MCA from Chandigarh University.</strong> I recently graduated with a degree in <strong>BCA</strong> from <strong>Dr. Bhimrao Ambedkar University, Agra</strong>, where I gained hands-on experience in front-end and back-end development using technologies like <strong>React, HTML, Node.js, MongoDB, JavaScript, and Tailwind CSS</strong>.
            </p>
            <p className="text-lg mb-6 font-serif">
